...
async function main() {
  ...
  // List 6 domains
  const names = ["jack.eth", "johny.eth", "henry.eth", "cobalt.eth", "oxygen.eth", "carbon.eth", "hello.eth"];
  const costs = [tokens(10), tokens(25), tokens(15), tokens(2.5), tokens(3), tokens(1), tokens(5)];
